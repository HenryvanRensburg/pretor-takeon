...
def main_app():
    ...
    if choice == "Dashboard":
        ...
        # (Simplified settings logic to save space, use full logic if needed)
        ...
        if sub_nav == "Overview":
            ...
            if not full_chk.empty:
                ...
                if agent_task_df.empty:
                    ...
                    if st.button("📥 Load Standard Checklist from Master", key="init_chk"):
                        ...
                        if res == "SUCCESS":
                            ...
                            st.error(f"Failed to load: {res}")
                else:
                    # 3. IF ITEMS EXIST, SHOW SELECTION LOGIC
                ...
                st.info("Checklist table empty.")

        # ... (Rest of tabs: Progress, Staff, etc. remain as previously coded) ...
        # To keep this response valid, I'm ensuring the main fix (initialize_checklist) is integrated.
        # The full previous code logic for other tabs should be here.
