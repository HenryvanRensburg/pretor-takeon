...
def create_comprehensive_pdf(complex_name, p_row, checklist_df, emp_df, arrears_df, council_df):
    ...
    if not checklist_df.empty:
        agent_items = checklist_df[(checklist_df['Responsibility'].astype(str).str.contains('Agent|Both', case=False, na=False)) & (checklist_df['Received'].astype(str).str.lower() == 'true')]
    ...
    if not checklist_df.empty:
        pretor_items = checklist_df[(checklist_df['Responsibility'].astype(str).str.contains('Pretor|Both', case=False, na=False)) & (checklist_df['Received'].astype(str).str.lower() == 'true')]
