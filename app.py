    ...
    if choice == "Dashboard":
        ...
        if sub_nav == "Overview":
            ...
            if not full_chk.empty:
                ...
                # UPDATED: Check for "Agent" OR "Both" to capture all variations
            ...
            # ... (Staff logic consistent with previous versions)
